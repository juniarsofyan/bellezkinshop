...
<div id='kotak'>
    ...
    <?php if (!isset($this->session->login_token)) : ?>
    <div id='joinreseller'><a href="<?php echo base_url('customers/login'); ?>">LOGIN RESELLER</a></div>
    <?php else : ?>
    <div id='joinreseller'><a href="<?php echo base_url('customers/logout'); ?>">LOGOUT</a></div>
    <?php endif; ?>
</div>
<?php endif; ?>
...
foreach ($breadcrumb as $item) :
    if ($item['active'] == 'yes') {
        ...
        $path .= "<a href='" . $item['url'] . "'>" . $item['label'] . "</a> &nbsp;>&nbsp;";
    }
endforeach;
